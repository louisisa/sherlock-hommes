...
export const Home = () => {
    ...
    const [blogs, setBlogs] = useState([
      ...
      {title: "The tea on T.T", desc: "In remeberence of Taiga Takahashi, the sartorial archeologist.", imglink:"./images/taiga_takahashi_header.jpg", id:2, urlroute: "art2", category:"Style"},
